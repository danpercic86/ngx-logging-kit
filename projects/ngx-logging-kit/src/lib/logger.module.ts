    ...
    static forRoot(
        ...
        if (!customProvider.configProvider) {
            ...
            if (customProvider.configProvider.provide !== TOKEN_LOGGER_CONFIG) {
                throw new Error(
                    `Wrong injection token for configProvider, it should be ${TOKEN_LOGGER_CONFIG.toString()} and you used ${customProvider.configProvider.provide}`,
                );
            }
        }
        ...
        if (!customProvider.configEngineFactoryProvider) {
            ...
            if (customProvider.configEngineFactoryProvider.provide !== TOKEN_LOGGER_CONFIG_ENGINE_FACTORY) {
                throw new Error(
                    `Wrong injection token for configEngineFactoryProvider, it should be '${TOKEN_LOGGER_CONFIG_ENGINE_FACTORY.toString()}' and you used '${customProvider.configEngineFactoryProvider.provide}'`,
                );
            }
        }
        ...
        if (!customProvider.metadataProvider) {
            ...
            if (customProvider.metadataProvider.provide !== TOKEN_LOGGER_METADATA_SERVICE) {
                throw new Error(
                    `Wrong injection token for metadataProvider, it should be '${TOKEN_LOGGER_METADATA_SERVICE.toString()}' and you used '${customProvider.metadataProvider.provide}'`,
                );
            }
        }
        ...
        if (!customProvider.ruleProvider) {
            ...
            if (customProvider.ruleProvider.provide !== TOKEN_LOGGER_RULES_SERVICE) {
                throw new Error(
                    `Wrong injection token for ruleProvider, it should be '${TOKEN_LOGGER_RULES_SERVICE.toString()}' and you used '${customProvider.ruleProvider.provide}'`,
                );
            }
        }
        ...
        if (!customProvider.mapperProvider) {
            ...
            if (customProvider.mapperProvider.provide !== TOKEN_LOGGER_MAPPER_SERVICE) {
                throw new Error(
                    `Wrong injection token for mapperProvider, it should be '${TOKEN_LOGGER_MAPPER_SERVICE.toString()}' and you used '${customProvider.mapperProvider.provide}'`,
                );
            }
        }
        ...
        if (!customProvider.writerProvider) {
            ...
            if (customProvider.writerProvider.provide !== TOKEN_LOGGER_WRITER_SERVICE) {
                throw new Error(
                    `Wrong injection token for writerProvider, it should be '${TOKEN_LOGGER_WRITER_SERVICE.toString()}' and you used '${customProvider.writerProvider.provide}'`,
                );
            }
        }
        ...
        if (!customProvider.serverProvider) {
            ...
            if (customProvider.serverProvider.provide !== TOKEN_LOGGER_SERVER_SERVICE) {
                throw new Error(
                    `Wrong injection token for serverProvider, it should be '${TOKEN_LOGGER_SERVER_SERVICE.toString()}' and you used '${customProvider.writerProvider.provide}'`,
                );
            }
        }
