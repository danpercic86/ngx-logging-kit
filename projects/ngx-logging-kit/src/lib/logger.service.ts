...
export class NGXLogger {
    ...
    trace(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.TRACE, message, additional);
    }
    ...
    debug(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.DEBUG, message, additional);
    }
    ...
    info(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.INFO, message, additional);
    }
    ...
    log(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.LOG, message, additional);
    }
    ...
    warn(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.WARN, message, additional);
    }
    ...
    error(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.ERROR, message, additional);
    }
    ...
    fatal(message?: unknown, ...additional: unknown[]): void {
        this.log_internal(NgxLogLevels.FATAL, message, additional);
    }
